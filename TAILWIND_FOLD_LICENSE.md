## End-User License Agreement (EULA) of Tailwind Fold's plugin ##

**"Developer"** means the author of Tailwind Fold: Vladislav Ogorodnik
...
**"Plugin"** means the Tailwind Fold Plugin for all JetBrains Products that Developer makes available under this EULA.
...
Tailwind Fold is a free Plugin with some paid functionality, you must ensure that the maximum number of paid functionality Plugin Users does not exceed the number of Plugin Users for which you have purchased paid functionality Plugin.
