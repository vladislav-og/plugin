## End-User License Agreement (EULA) of Pomodoro Healthy Exercise Timer's plugin ##

**"Developer"** means the author of Pomodoro Healthy Exercise Timer: Vladislav Ogorodnik
...
**"Plugin"** means the Pomodoro Healthy Exercise Timer Plugin for all JetBrains Products that Developer makes available under this EULA.
...
Pomodoro Healthy Exercise Timer is a free Plugin with some paid functionality, you must ensure that the maximum number of paid functionality Plugin Users does not exceed the number of Plugin Users for which you have purchased paid functionality Plugin.
