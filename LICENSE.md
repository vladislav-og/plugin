## End-User License Agreement (EULA) of Color Palette Generator's plugin ##

**"Developer"** means the author of Color Palette generator: Vladislav Ogorodnik
...
**"Plugin"** means the Color Palette Generator Plugin for all JetBrains Products that Developer makes available under this EULA.
...
Color Palette Generator is a free Plugin with some paid functionality, you must ensure that the maximum number of paid functionality Plugin Users does not exceed the number of Plugin Users for which you have purchased paid functionality Plugin.
